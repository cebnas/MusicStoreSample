            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
                {
                    ...
                    tokenValidationParams.IssuerSigningKey = new SymmetricSecurityKey(privateKey);
                    tokenValidationParams.ValidateIssuer = false;
                    tokenValidationParams.ValidateAudience = false;
